    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-headline font-black mb-6 leading-none">
      ...
      <section className="container mx-auto px-6 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {SPORTS.map((sport) => (
            <Link key={sport.slug} href={sport.href} className="group luxury-card p-10 block relative overflow-hidden">
              ...
              <div className="absolute bottom-10 right-10 transform transition-transform duration-300 group-hover:translate-x-2 text-primary">
                <ArrowRight size={24} />
              </div>
            </Link>
          ))}
      ...
      <section id="registration" className="border-y border-primary/20 bg-[#111111]">
        <div className="container mx-auto px-6 py-20 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-2xl">
            <h2 className="text-4xl font-headline font-bold mb-4">Register Your Team</h2>
      ...
      {/* Registration Form */}
      <section id="register-form" className="container mx-auto px-6 py-32 max-w-4xl">
        <div className="luxury-card p-12 border-primary/40">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-headline font-bold mb-2">Registration Portal</h2>
